...
; drawGame
;	In:	rbx = base
;		rax = Pos.materialTable
	GetKeys   rcx, rdx, <King>, <King>
	call	AddDrawKey
	mov	rcx, rdx
	call	AddDrawKey
	GetKeys   rcx, rdx, <King, Knight>, <King>
	call	AddDrawKey
	mov	rcx, rdx
	call	AddDrawKey
	GetKeys   rcx, rdx, <King, Bishop>, <King>
	call	AddDrawKey
	mov	rcx, rdx
	call	AddDrawKey
	GetKeys   rcx, rdx, <King, Knight>, <King, Knight>
	call	AddDrawKey
	mov	rcx, rdx
	call	AddDrawKey
	GetKeys   rcx, rdx, <King, Knight>, <King, Bishop>
	call	AddDrawKey
	mov	rcx, rdx
	call	AddDrawKey
	ret
AddDrawKey:
	mov	r8, rcx
	and	r8d, MATERIAL_HASH_ENTRY_COUNT-1
	shl	r8d, 4
	add	r8, rax		;qword[rbp+Pos.materialTable]
	mov	qword[r8+MaterialEntry.key], rcx
	mov	byte[r8+MaterialEntry.evaluationFunction], ENDGAME_EVAL_MAX_INDEX
	ret
end if
Endgame_Init:
